    ...
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                cloudStorageAccount = CloudStorageAccount.Parse("DefaultEndpointsProtocol=http;AccountName=aspnetgetstarted20181119;AccountKey=ees2hLI8jcKMncqUwos581KsoCrQTyiJrg0Hm2AnkkAIuU9VO2YTXd8zPMc9bBsIP1ptvQpCmmseOBR9kaSR1g==");
